...
ZONE_ALARM_MEMORY_EXPOSURE_ALARM_PANEL = "alarm_panel"
ZONE_ALARM_MEMORY_EXPOSURE_BOTH = "both"
DEFAULT_ZONE_ALARM_MEMORY_EXPOSURE = ZONE_ALARM_MEMORY_EXPOSURE_BINARY_SENSOR
